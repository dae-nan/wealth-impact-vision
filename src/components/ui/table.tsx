...
>(({ className, ...props }, ref) => (
  <thead ref={ref} className={cn("[&_tr]:border-b bg-sc-neutral-100", className)} {...props} />
))
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-12 px-4 text-left align-middle font-semibold text-sc-blue [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
